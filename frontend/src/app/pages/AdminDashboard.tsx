  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          { label: "Total Laporan", value: "1,284", icon: FileText, trend: "+12%", color: "blue" },
          { label: "Aktif", value: "48", icon: TrendingUp, trend: "+5%", color: "indigo" },
          { label: "Selesai", value: "1,120", icon: CheckCircle2, trend: "+18%", color: "green" },
          { label: "Tertunda", value: "116", icon: AlertCircle, trend: "-2%", color: "orange" },
        ].map((stat, i) => (
          <motion.div
            key={stat.label}
            ...
            <div className="p-4 bg-blue-50 rounded-2xl border border-blue-100">
              <div className="flex items-center gap-3 mb-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-gray-500">12 dari 15 teknisi aktif</p>
                </div>
              </div>
