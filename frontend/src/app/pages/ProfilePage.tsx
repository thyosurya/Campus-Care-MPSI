...
export const ProfilePage: React.FC = () => {
  ...
  const userData = {
    ...
    email: auth?.user.email ?? "budi.santoso@university.ac.id",
    id: "12345678",
        ...
        <div className="absolute -bottom-12 left-8 flex items-end gap-6">
          ...
          <div className="pb-4">
            ...
            <p className="text-gray-500 font-medium">
              {userData.roleName} • {userData.department}
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 pt-12">
        ...
        <div className="space-y-6">
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 p-4 border-2 border-red-100 text-red-600 rounded-2xl font-bold hover:bg-red-50 transition-colors"
          >
